...
@Entity
@Table(name = "SP_VKURS", schema = "TICKET")
public class VkursSP implements Serializable {

	private static final long serialVersionUID = -635267356171157185L;
	...
	public VkursSP(Date datan, Date datak, String kodg, double kurs, double okr, double nds, String kodv, String nazv) {
		super();
		this.datan = datan;
		this.datak = datak;
		this.kodg = kodg;
	...
	public String toString() {
		return "VkursSP [datan=" + datan + ", datak=" + datak + ", kodg=" + kodg + ", kurs=" + kurs + ", okr=" + okr
